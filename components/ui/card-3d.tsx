  ...
  return (
    <div className={`relative ${containerClassName}`}>
      ...
      >
        ...
        {glowEffect && (
          <div 
            ...
            style={{
              ...
              background: `radial-gradient(400px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(30, 155, 113, 0.2), transparent 40%)`,
            }}
          />
        )}
        ...
        {/* Animated Border */}
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-primary/50 via-transparent to-primary/50 opacity-0 transition-opacity duration-300 pointer-events-none" 
