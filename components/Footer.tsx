...
const Footer = () => {
  ...
  return (
    <footer className="bg-surface/30 backdrop-blur-sm border-t border-white/10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Transform your body and mind with our premium fitness equipment, expert trainers, and supportive community.
            </p>
          </motion.div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-white/60 hover:text-white hover:bg-primary transition-all duration-200"
